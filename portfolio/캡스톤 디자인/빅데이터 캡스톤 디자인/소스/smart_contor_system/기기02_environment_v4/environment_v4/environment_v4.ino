...
String x="37.84760420000002",y="127.79354290000002",tempx,tempy;//37.8476042
...
#define ZERO_POINT_VOLTAGE (0.08) //define the output of the sensor in volts when the concentration of CO2 is 400PPM
#define REACTION_VOLTGAE (0.01) //define the voltage drop of the sensor when move the sensor from air into 1000ppm CO2
/*****************************Globals***********************************************/
...
/*
  ...
  */
  ...
  cmd += "jeane1993.cafe24.com"; // api.thingspeak.com 접속 IP
  ...
  getStr +="&element2=";
  getStr += String(abs(dustDensityug)); // 미세먼지 
  getStr +="&element3=";
