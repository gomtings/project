...
String x="37.8866208",y="127.7398225",tempx,tempy;
...
#define ZERO_POINT_VOLTAGE (0.04) //define the output of the sensor in volts when the concentration of CO2 is 400PPM
...
/*
  ...
  */
  ...
  cmd += "tkddn4508.dothome.co.kr"; // api.thingspeak.com 접속 IP
