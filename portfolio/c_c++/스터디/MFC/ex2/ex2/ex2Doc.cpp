...
// 축소판 그림을 지원합니다.
void Cex2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void Cex2Doc::InitializeSearchContent()
{
...
void Cex2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
